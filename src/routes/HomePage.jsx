...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      <div id="root-paras-1" className="relative" style={para1Style}>
        <p className="mt-10 p-3 font-bold text-white text-3xl text-center">
          Buy Items With Crypto
        </p>
        <p className="mt-2 p-6 text-center font-light">
          Purchase various items from major retailers with your Crypto!
        </p>
      </div>
      ...
      <div id="root-paras-2" className="relative" style={para1Style}>
        <p className="mt-6 p-3 font-bold text-white text-2xl text-center">
          A Wide Range of Items
        </p>
        <p className="mt-2 p-6 text-center leading-relaxed font-light">
          You are merely a few clicks away from placing an order for items you
          like from the following retailers!
        </p>
      </div>
      <div className="mt-8 p-10">
        <div
      ...
      <div id="root-paras-3" className="relative" style={para1Style}>
        <p className="mt-4 p-3 font-bold text-white text-2xl text-center">
          Choices of Payment Method
        </p>
        <p className="mt-2 p-6 text-center leading-relaxed font-light">
          We support{" "}
          <span className="font-normal">
            Bitcoin, Bitcoin Cash, Monero, Ethereum, Dogecoin and Litecoin!
          </span>
        </p>
      </div>
      <img
      ...
      />
      <div id="root-paras-4" className="relative" style={para1Style}>
        <p className="mt-6 p-3 font-bold text-white text-2xl text-center">
          No Registration Required
        </p>
        <p className="mt-2 p-6 text-center leading-relaxed font-light">
          Save the hassle of having to register, and dive right in for shopping!
        </p>
      </div>
      <img
        src={handShake}
      ...
      />
      <div id="root-paras-5" className="relative" style={para1Style}>
        <p className="mt-6 p-3 font-bold text-white text-2xl text-center">
          Earn Your Choice of Crypto
        </p>
        <p className="mt-2 p-6 text-center leading-relaxed font-light">
          Become our member, fulfill orders for others and earn your choice of
          Crypto!
        </p>
      </div>
    </div>

...
export default function ListCustomerUserOrders() {
  ...
  const useEffectAsync = async () => {
    ...
    const response = await fetch(
      "http://127.0.0.1:8000/api/list-order/?for=customer&page=1",
      fetchOptions
    );
  ...
  return (
    <div className="p-16">
      <p className="font-semibold text-xl">Your List of Orders as Customer</p>
